...
<div class="container mt-5 ml-4">
    <form:form class="form" method="post" enctype="multipart/form-data" action="/moim/add.do" modelAttribute="moimForm">
        ...
        <div class="form-group">
         <i class="mr-2 fas fa-map-marker" style="color: #0F4C81;"></i><label>상세지역</label>
		<form:input id="map-address" type="text" path="locationDetail" placeholder="주소를 검색해주세요" size="80" readonly="true"/>
		<input type="button" onclick="showAddress()" value="주소 검색"><br>
        </div>
    ...
    function showAddress() {
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                document.getElementById("map-address").value = addr;
            }
        }).open();
    };
</script>